...
class WardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ward" do
    assert_difference('Ward.count') do
      post wards_url, params: { ward: { wardname: @ward.wardname, wardno: @ward.wardno, zoneid: @ward.zoneid } }
    end
  ...
  test "should update ward" do
    patch ward_url(@ward), params: { ward: { wardname: @ward.wardname, wardno: @ward.wardno, zoneid: @ward.zoneid } }
