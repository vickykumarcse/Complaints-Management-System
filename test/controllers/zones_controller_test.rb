...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { admin_username: @zone.admin_username, zonename: @zone.zonename } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { admin_username: @zone.admin_username, zonename: @zone.zonename } }
