...
class UpvotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upvote" do
    assert_difference('Upvote.count') do
      post upvotes_url, params: { upvote: { has_many: @upvote.has_many, has_many: @upvote.has_many } }
    end
  ...
  test "should update upvote" do
    patch upvote_url(@upvote), params: { upvote: { has_many: @upvote.has_many, has_many: @upvote.has_many } }
